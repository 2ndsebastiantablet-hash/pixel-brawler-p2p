...
export const COMBAT_TUNING = {
  ...
  weaponWeights: {
    ...
    "pet-bear": { label: "Light", moveSpeedMultiplier: 1.01, accelerationMultiplier: 1.04, airAccelerationMultiplier: 1.02, jumpMultiplier: 1, slideMultiplier: 1.01 },
    "pet-cat": { label: "Light", moveSpeedMultiplier: 1.02, accelerationMultiplier: 1.06, airAccelerationMultiplier: 1.04, jumpMultiplier: 1, slideMultiplier: 1.02 },
    "pet-dog": { label: "Light", moveSpeedMultiplier: 1.02, accelerationMultiplier: 1.06, airAccelerationMultiplier: 1.04, jumpMultiplier: 1, slideMultiplier: 1.02 },
    "pet-deer": { label: "Light", moveSpeedMultiplier: 1.03, accelerationMultiplier: 1.08, airAccelerationMultiplier: 1.06, jumpMultiplier: 1.02, slideMultiplier: 1.02 },
    "pet-parrot": { label: "Light", moveSpeedMultiplier: 1.02, accelerationMultiplier: 1.05, airAccelerationMultiplier: 1.08, jumpMultiplier: 1, slideMultiplier: 1.02 },
    "pet-chipmunk": { label: "Light", moveSpeedMultiplier: 1.03, accelerationMultiplier: 1.08, airAccelerationMultiplier: 1.06, jumpMultiplier: 1, slideMultiplier: 1.04 },
    ...
    mars: { label: "Light", moveSpeedMultiplier: 1.04, accelerationMultiplier: 1.08, airAccelerationMultiplier: 1.08, jumpMultiplier: 1.02, slideMultiplier: 1.02 },
    neptune: { label: "Light", moveSpeedMultiplier: 1.04, accelerationMultiplier: 1.08, airAccelerationMultiplier: 1.1, jumpMultiplier: 1.03, slideMultiplier: 1.02 },
