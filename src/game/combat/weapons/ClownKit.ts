...
export const clownKit: WeaponDefinition = {
  ...
  name: "Clown Kit",
  kind: "utility",
  description: "Head item. Gives clown mask, big gloves, and a back balloon glide. Empty hand required. Left click fires 2-damage finger-gun bullets with huge knockback. Right click makes balloon tools.",
  ...
  mastery: ["Head item", "Back balloon", "Empty-hand kit", "Finger gun", "Balloon tools"],
};
