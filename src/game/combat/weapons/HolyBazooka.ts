...
export const holyBazooka: WeaponDefinition = {
  ...
  secondary: { damage: 0, cooldown: 7, range: 0, knockback: 0, stun: 0 },
  ...
  mastery: ["10s ammo pickups", "7s cooldown", "Homing missile", "Huge holy splash", "Health steal", "Massive recoil"],
};
