...
- Twenty-one enabled polished weapons/items for this slice: pistol, whip, teleporting ball, lightning rod, sledgehammer, slingshot, laser blaster, revolver, minigun, sniper, knife, machete, axe, wings, virgin blood, death aura, rocket, hands, super legs, holy bazooka, and grappling hook.
...
- Right mouse: Use the held item alternate/secondary action, such as Knife throw, Axe throw/recall, Rocket light, Holy Bazooka ammo call, Grappling Hook release, or Virgin Blood consume. Pistol right click does not throw the pistol.
...
- Grappling Hook Ropes: Grapples live in the combat snapshot as segmented rope state separate from normal projectiles. Local ropes attach to surfaces or combatants, lightly damage player/enemy targets through hit packets, pull the owner with capped force/speed, and release by right click, death/invalid target, or extreme snap distance. Remote primary/release events spawn matching visual-only ropes without changing signaling code.
...
- Combat is a playable twenty-one-weapon/item vertical slice, not final balance.
