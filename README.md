...
- Thirty-three enabled polished weapons/items for this slice: pistol, whip, teleporting ball, lightning rod, sledgehammer, slingshot, laser blaster, revolver, minigun, sniper, knife, machete, axe, wings, grabber, trident, virgin blood, death aura, rocket, hands, super legs, holy bazooka, grappling hook, chainsaw, spikes, van, Spirit of a Fighter, cross, The Moon, Jupiter, Uranus, Mars, and Neptune.
...
- Grabber is a regular front/back strap utility, not a `Q`/`E` Space event. When strapped, it passively adds a mechanical glove arm, a third F-cycle storage slot, animated empty auto-punches, and farther pickup reach.
...
- Combat is a playable thirty-three-weapon/item vertical slice, not final balance.
