...
- Cross Judgment: Cross shields and Judgment Day beams live in the combat snapshot/event flow. The shield uses normal combat hit events for pushback/projectile deflection, while remote Judgment Day events spawn visual-only beam storms and actual damage syncs through the same hit packets as other combat effects.
