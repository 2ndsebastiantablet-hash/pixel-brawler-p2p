...
- Spirit Focus: Spirit of a Fighter is a strap mode rather than a normal hand attack. Beat Focus and Winded are synced statuses, the local timing HUD shows beat/combo/feedback/cooldown plus heart/beat-line focus visuals, and the full-screen gray focus treatment stays local so remote multiplayer simulation is not slowed.
